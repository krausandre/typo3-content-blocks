...
var __decorate=function(t,e,o,n){var c,s=arguments.length,i=s<3?e:null===n?n=Object.getOwnPropertyDescriptor(e,o):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)i=Reflect.decorate(t,e,o,n);else for(var a=t.length-1;a>=0;a--)(c=t[a])&&(i=(s<3?c(i):s>3?c(e,o,i):c(e,o))||i);return s>3&&i&&Object.defineProperty(e,o,i),i};import{html,LitElement}from"lit";import{customElement,property}from"lit/decorators.js";import"@typo3/backend/element/icon-element.js";import AjaxRequest from"@typo3/core/ajax/ajax-request.js";let ContentBlockList=class extends LitElement{constructor(){super(),this.contentBlocks=[],this.basics=[],this.icon="actions-question-circle",this.loadContentBlocks()}render(){return html`
    ...
    `}loadContentBlocks(){this.loading=!0,new AjaxRequest(TYPO3.settings.ajaxUrls.content_blocks_gui_list_cb).post({}).then((async t=>{const e=await t.resolve();this.contentBlocks=Object.keys(e.body.contentBlocks).map((t=>e.body.contentBlocks[t])),this.basics=Object.keys(e.body.basics).map((t=>e.body.basics[t])),this.loading=!1})).catch((t=>{console.error(t),this.loading=!1}))}async _loadContentBlockData(t){this.loading=!0,await new AjaxRequest(TYPO3.settings.ajaxUrls.content_blocks_gui_get_cb).post({name:t}).then((async t=>(await t.resolve()).body)).catch((t=>(console.error(t),null)))}_downloadAction(t){new AjaxRequest(TYPO3.settings.ajaxUrls.content_blocks_gui_download_cb).post({name:t},{headers:{"Content-Type":"application/json",Accept:"application/zip"}}).then((async e=>{const o=e.raw(),n=await o.blob(),c=o.headers.get("content-disposition");let s=t+".zip";if(c){const t=c.match(/filename="?([^"]+)"?/);t&&t.length>1&&(s=t[1])}s=s.replace(/"+$/,"");const i=window.URL.createObjectURL(n),a=document.createElement("a");a.href=i,a.setAttribute("download",s),document.body.appendChild(a),a.click()})).catch((t=>{console.error(t)}))}_dispatchEditEvent(t){this._loadContentBlockData(t).then((e=>{console.log(e),this.dispatchEvent(new CustomEvent("contentBlockEdit",{detail:{name:t,data:this.contentBlockData}}))}))}_dispatchCopyEvent(t){this.dispatchEvent(new CustomEvent("contentBlockCopy",{detail:{name:t}}))}createRenderRoot(){return this}};__decorate([property()],ContentBlockList.prototype,"contentBlocks",void 0),ContentBlockList=__decorate([customElement("content-block-list")],ContentBlockList);export{ContentBlockList};