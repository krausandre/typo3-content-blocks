...
(function (Identifiers) {
    Identifiers["output"] = ".t3js-coreUpdate-output";
    Identifiers["updateButton"] = ".t3js-coreUpdate-button";
...
class CoreUpdate extends AbstractInteractableModule {
    ...
    initialize(currentModal) {
        ...
        this.loadModuleFrameAgnostic('@typo3/install/renderable/flash-message.js').then(async () => {
            await this.getData();
            this.buttonTemplate = this.findInModal(Identifiers.updateButton)?.cloneNode(true);
        });
