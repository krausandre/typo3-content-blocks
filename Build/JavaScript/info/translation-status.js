...
class TranslationStatus {
    ...
    async toggleNewButton() {
        const relatedCreationButton = document.querySelector(`.t3js-language-new[data-lang="${this.dataset.lang}"]`);
        const relatedCreationButtonIcon = relatedCreationButton.querySelector('.t3js-icon');
