            ...
            try {
                ...
                if (data.errorCount > 0) {
                    ...
                    modal.addEventListener('typo3-modal-shown', () => {
                        ...
                        modal.querySelector('input[name="unlockDependencyIgnoreButton"]').addEventListener('change', (e) => {
                ...
                Notification.error(TYPO3.lang['extensionList.dependenciesResolveInstallError.title'] || 'Install error', TYPO3.lang['extensionList.dependenciesResolveInstallError.message'] || 'Your installation failed while resolving dependencies.');
            }
        }, () => {
            Notification.error(TYPO3.lang['extensionList.dependenciesResolveInstallError.title'] || 'Install error', TYPO3.lang['extensionList.dependenciesResolveInstallError.message'] || 'Your installation failed while resolving dependencies.');
        }).finally(() => {
