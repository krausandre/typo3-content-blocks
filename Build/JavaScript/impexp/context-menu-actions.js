...
class ContextMenuActions {
    exportT3d(table, uid, dataset) {
        const actionUrl = dataset.actionUrl;
        if (table === 'pages') {
            top.TYPO3.Backend.ContentContainer.setUrl(actionUrl +
                '&id=' + uid +
    ...
    importT3d(table, uid, dataset) {
        const actionUrl = dataset.actionUrl;
        top.TYPO3.Backend.ContentContainer.setUrl(actionUrl + '&id=' + uid + '&table=' + table);
    }
}
