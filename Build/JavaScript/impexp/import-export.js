...
class ImportExport {
    ...
    triggerConfirmation() {
        ...
        modal.addEventListener('confirm.button.ok', () => {
            const submitTrigger = document.getElementById('t3js-submit-field');
    ...
    toggleDisabled() {
        const checkboxes = document.querySelectorAll('table.t3js-impexp-preview tr[data-active="hidden"] input.t3js-exclude-checkbox');
