...
(function (Identifiers) {
    ...
    Identifiers["newFormModeButton"] = "[data-identifier=\"newFormModeButton\"]";
    Identifiers["newFormName"] = "[data-identifier=\"newFormName\"]";
    Identifiers["newFormSavePath"] = "[data-identifier=\"newFormSavePath\"]";
    Identifiers["newFormPrototypeName"] = "[data-identifier=\"newFormPrototypeName\"]";
    Identifiers["newFormTemplate"] = "[data-identifier=\"newFormTemplate\"]";
    Identifiers["duplicateFormName"] = "[data-identifier=\"duplicateFormName\"]";
    Identifiers["duplicateFormSavePath"] = "[data-identifier=\"duplicateFormSavePath\"]";
    Identifiers["showReferences"] = "[data-identifier=\"showReferences\"]";
    Identifiers["referenceLink"] = "[data-identifier=\"referenceLink\"]";
    Identifiers["moduleBody"] = ".module-body.t3js-module-body";
    Identifiers["t3Logo"] = ".t3-message-page-logo";
    Identifiers["t3Footer"] = "#t3-footer";
    Identifiers["formsTable"] = "#forms";
...
function newFormSetup(formManagerApp) {
    $(Identifiers.newFormModalTrigger).on('click', function (e) {
        ...
        MultiStepWizard.addSlide('new-form-step-1', TYPO3.lang['formManager.newFormWizard.step1.title'], '', Severity.notice, TYPO3.lang['formManager.newFormWizard.step1.progressLabel'], async function (slide) {
            ...
            html += '</div>';
            slide.html(html);
            $(Identifiers.newFormModeButton, modal).on('click', function (e) {
        ...
        MultiStepWizard.addSlide('new-form-step-2', TYPO3.lang['formManager.newFormWizard.step2.title'], '', Severity.notice, top.TYPO3.lang['wizard.progressStep.configure'], function (slide, settings) {
            ...
            $(Identifiers.newFormPrototypeName, modal).on('change', function (e) {
            ...
            $(Identifiers.newFormName, modal).on('keyup paste', function (e) {
        ...
        MultiStepWizard.addFinalProcessingSlide(function () {
            $.post(formManagerApp.getAjaxEndpoint('create'), {
                ...
                const parser = new DOMParser(), responseDocument = parser.parseFromString(jqXHR.responseText, 'text/html'), responseBody = $(responseDocument.body);
...
function removeFormSetup(formManagerApp) {
    $(Identifiers.removeFormModalTrigger).on('click', function (e) {
        const modalButtons = [];
        e.preventDefault();
        ...
        Modal.show(TYPO3.lang['formManager.remove_form_title'], TYPO3.lang['formManager.remove_form_message'].replace('{0}', that.data('formName')), Severity.error, modalButtons);
    });
}
/**
 * @throws 1477649539
...
function duplicateFormSetup(formManagerApp) {
    $(Identifiers.duplicateFormModalTrigger).on('click', function (e) {
        e.preventDefault();
        const that = $(e.currentTarget);
        /**
         * Wizard step 1
        ...
        MultiStepWizard.addSlide('duplicate-form-step-1', TYPO3.lang['formManager.duplicateFormWizard.step1.title'].replace('{0}', that.data('formName')), '', Severity.notice, top.TYPO3.lang['wizard.progressStep.configure'], function (slide) {
            ...
            $(Identifiers.duplicateFormName, modal).on('keyup paste', function (e) {
...
function showReferencesSetup(formManagerApp) {
    $(Identifiers.showReferences).on('click', (e) => {
        e.preventDefault();
        const $that = $(e.currentTarget);
        ...
        $.get(url, async function (data) {
            ...
            Modal.show(TYPO3.lang['formManager.references.title'].replace('{0}', $that.data('formName')), html, Severity.notice, modalButtons);
        }).fail(function (jqXHR, textStatus, errorThrown) {
            if (jqXHR.status !== 0) {
                Notification.error(textStatus, errorThrown, 2);
            }
...
function initializeSortable() {
    const formsList = document.querySelector(Identifiers.formsTable);
    if (formsList !== null) {
