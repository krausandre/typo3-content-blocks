...
import { LINK_ALLOWED_ATTRIBUTES, addLinkPrefix } from '@typo3/rte-ckeditor/plugin/typo3-link';
/**
...
class RteLinkBrowser {
    ...
    convertAttributes(attributes, text) {
        const linkAttr = { attrs: {} };
