...
export default class Severity {
    static { this.notice = SeverityEnum.notice; }
    static { this.info = SeverityEnum.info; }
    static { this.ok = SeverityEnum.ok; }
    static { this.warning = SeverityEnum.warning; }
    static { this.error = SeverityEnum.error; }
    /**
