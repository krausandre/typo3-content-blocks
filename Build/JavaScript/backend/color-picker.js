...
let Typo3BackendColorPicker = class Typo3BackendColorPicker extends LitElement {
    constructor() {
        super(...arguments);
        this.color = '';
        this.opacity = false;
...
], Typo3BackendColorPicker.prototype, "color", void 0);
__decorate([
    property({ type: Boolean })
], Typo3BackendColorPicker.prototype, "opacity", void 0);
__decorate([
    property({ type: String })
], Typo3BackendColorPicker.prototype, "swatches", void 0);
__decorate([
    query('slot')
], Typo3BackendColorPicker.prototype, "slotEl", void 0);
Typo3BackendColorPicker = __decorate([
    customElement('typo3-backend-color-picker')
], Typo3BackendColorPicker);
