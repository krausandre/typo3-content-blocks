...
class Icons {
    constructor() {
        ...
        this.promiseCache = new DedupeAsyncTask();
    }
    /**
     * Get the icon by its identifier
     */
    async getIcon(identifier, size, overlayIdentifier, state, markupIdentifier, signal) {
        /**
         * Icon keys:
         *
         * 0: identifier
     ...
     */
    fetchFromRemote(icon, cacheIdentifier, signal) {
        return this.promiseCache.get(cacheIdentifier, async (signal) => {
