...
class UserPassLogin {
    constructor() {
         ...
         */
        this.resetPassword = () => {
            const passwordField = document.querySelector(this.options.passwordField);
            if (passwordField === null || passwordField.value === '') {
                return;
            }
            const userIndent = document.querySelector(Login.options.useridentField);
            if (userIndent) {
         ...
         * Capslock handling
         */
        this.attachCapslockWarning = (element, label, message) => {
    ...
    `;
         ...
         */
        this.attachPasswordToggle = (element) => {
    ...
    `;
        ...
        this.removePasswordToggle = (element) => {
            const container = element.closest('.input-group');
            if (!container) {
                return;
            }
        ...
        const usernameField = document.querySelector(this.options.usernameField);
        const passwordField = document.querySelector(this.options.passwordField);
        const copyrightLink = document.querySelector(this.options.copyrightLink);
