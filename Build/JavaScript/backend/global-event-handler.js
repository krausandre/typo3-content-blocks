...
class GlobalEventHandler {
    ...
    handleFormChildAction(evt, resolvedTarget) {
        const actionSubmit = resolvedTarget.dataset.actionSubmit;
        const actionFocus = resolvedTarget.dataset.actionFocus;
        ...
        if (actionFocus && parentForm) {
            ...
            const formFieldElement = parentForm.querySelector(actionFocus);
    ...
    assignFormValues(form, resolvedTarget) {
        ...
        Object.entries(formValues).forEach(([name, value]) => {
            ...
            if (item instanceof HTMLElement) {
                this.assignHTMLFormChildElementValue(item, value.toString());
            }
            else {
    ...
    assignHTMLFormChildElementValue(element, value) {
        const type = element.getAttribute('type');
        if (element instanceof HTMLSelectElement) {
