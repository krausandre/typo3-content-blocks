...
export class TsCodeCompletion {
     ...
     */
    refreshCodeCompletion(completionState) {
        ...
        this.compResult = new CompletionResult(this.tsRef, currentTsTreeNode);
     ...
     */
    resolveExtReferencesRec(childNodes) {
