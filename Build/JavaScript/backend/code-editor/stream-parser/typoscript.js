class TSLexical {
    constructor(indented, column, type, align, prev, info) {
...
export class TypoScriptStreamParserFactory {
    create() {
        ...
        function contCommasep(what, end, info, ...rest) {
        ...
        // Interface
        class TypoScriptStreamParser {
            constructor() {
                this.electricInput = /^\s*(?:case .*?:|default:|\{|\})$/;
                this.blockCommentStart = '/*';
                this.blockCommentEnd = '*/';
                this.lineComment = '#';
                this.fold = 'brace';
                this.closeBrackets = '(){}\'\'""`';
                this.helperType = 'typoscript';
                this.name = 'TypoScript';
            }
            ...
            indent(state, textAfter, cx) {
                ...
                let top;
                while ((lexical.type === 'stat' || lexical.type === 'form') && (firstChar === '}' || ((top = state.cc[state.cc.length - 1]) &&
            ...
            expressionAllowed(stream, state) {
