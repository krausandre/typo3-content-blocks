...
class TablesortWithButtons extends Tablesort {
    init(el, options) {
        ...
        const onClick = (event) => {
            ...
            const target = event.currentTarget.closest('th, td');
...
export default class SortableTable {
    constructor(table) {
        table.addEventListener('afterSort', (event) => {
            ...
            const sortingCell = table.tHead.querySelector('th[aria-sort]');
