...
let DefaultProviderResultItem = class DefaultProviderResultItem extends LitElement {
    createRenderRoot() {
...
], DefaultProviderResultItem.prototype, "icon", void 0);
__decorate([
    property({ type: String, attribute: false })
], DefaultProviderResultItem.prototype, "itemTitle", void 0);
__decorate([
    property({ type: String, attribute: false })
], DefaultProviderResultItem.prototype, "typeLabel", void 0);
__decorate([
    property({ type: Object, attribute: false })
], DefaultProviderResultItem.prototype, "extraData", void 0);
DefaultProviderResultItem = __decorate([
    customElement('typo3-backend-live-search-result-item-default')
], DefaultProviderResultItem);
export { DefaultProviderResultItem };
