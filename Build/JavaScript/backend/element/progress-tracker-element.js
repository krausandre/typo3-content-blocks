 ...
 */
let ProgressTrackerElement = class ProgressTrackerElement extends LitElement {
    constructor() {
        super(...arguments);
        this.stages = [];
        this.activeStage = 0;
...
__decorate([
    property({ attribute: 'stages', type: Array })
], ProgressTrackerElement.prototype, "stages", void 0);
__decorate([
    property({ attribute: 'active', type: Number, reflect: true })
], ProgressTrackerElement.prototype, "activeStage", void 0);
ProgressTrackerElement = __decorate([
