...
export const TreeModuleState = (superClass) => {
    class TreeModuleStateClass extends superClass {
        constructor() {
            super(...arguments);
            /**
             ...
             */
            this.selectActiveNodeInLoadedNodes = (evt) => {
                ...
                const nodeToActivate = nodes.find((node) => ((moduleState.treeIdentifier !== null && node.__treeIdentifier === treeIdentifier) ||
                ...
                if (moduleState.treeIdentifier === null) {
                    moduleState = ModuleStateStorage.updateWithTreeIdentifier(this.moduleStateType, this.transformNodeIdentifierToModuleStateIdentifier(nodeToActivate.identifier), this.transformNodeIdentifierToModuleStateIdentifier(nodeToActivate.__treeIdentifier));
                }
            ...
            this.fetchActiveNodeIfMissing = async () => {
            ...
            this.moduleStateUpdated = async (e) => {
        ...
        async selectActiveViaRootline(identifier) {
            ...
            const { rootline } = await response.resolve();
            rootline.pop();
            const propagate = false;
        ...
        async selectActiveNodeByParents(identifier, parents, propagate = true) {
